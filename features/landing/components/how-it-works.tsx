    ...
    <section id="how-it-works" aria-labelledby="how-it-works-heading" className="px-6 py-20">
      <div className="mx-auto max-w-6xl">
        <div className="mb-14 text-center">
          <h2 id="how-it-works-heading" className="mb-3 text-3xl font-bold tracking-tight text-dark-grey dark:text-foreground">Up and running in minutes</h2>
        ...
        <div className="relative grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          {STEPS.map(({ step, icon: Icon, title, desc, color }) => (
            <div key={step} className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className="mb-2 text-lg font-semibold text-dark-grey dark:text-foreground">{title}</h3>
