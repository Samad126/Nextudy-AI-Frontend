    ...
    <section className="px-6 py-20">
      <div className="mx-auto max-w-3xl text-center">
        <div className="rounded-2xl bg-dark-grey px-8 py-12 dark:bg-card dark:ring-1 dark:ring-border">
          {isLoggedIn ? (
            <>
              <h2 className="mb-3 text-3xl font-bold tracking-tight text-white dark:text-foreground">Welcome back!</h2>
              <p className="mb-6 text-base text-white/70 dark:text-muted-foreground">Head to your dashboard and keep up the great work.</p>
